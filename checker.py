...
''')
    ...
    def printinfo(self):
        ...
        ctypes.windll.kernel32.SetConsoleTitleW(
            f'Nexus  |  Checked {self.checked}/{self.count}  |  {self.cpmtext} CPM  |  Hitrate {percent}  |  Est. time: {self.esttime}')
        os.system('cls')
        print(f'''
    
    
 ┏━ Main ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓ ┏━━ Regions ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓ ┏━━ Skins ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [>] Valid          >>:[{self.valid}] ({percent}){space * (9 - len(str(self.valid))-len(percent))}┃ ┃ [>] EU            >>:[{self.regions['eu']}]{space * (18 - len(str(self.regions['eu'])))}┃ ┃ [>] 1-10            >>:[{self.skinsam['1-10']}]{space * (29 - len(str(self.skinsam['1-10'])))}┃
 ┃ [>] Banned         >>:[{self.banned}]{space * (12 - len(str(self.banned)))}┃ ┃ [>] NA            >>:[{self.regions['na']}]{space * (18 - len(str(self.regions['na'])))}┃ ┃ [>] 10-20           >>:[{self.skinsam['10-20']}]{space * (29 - len(str(self.skinsam['10-20'])))}┃
 ┃ [>] TempBanned     >>:[{self.tempbanned}]{space * (12 - len(str(self.tempbanned)))}┃ ┃ [>] AP            >>:[{self.regions['ap']}]{space * (18 - len(str(self.regions['ap'])))}┃ ┃ [>] 20-35           >>:[{self.skinsam['20-35']}]{space * (29 - len(str(self.skinsam['20-35'])))}┃
 ┃ [>] Riot Limits    >>:[{self.rlimits}]{space * (12 - len(str(self.rlimits)))}┃ ┃ [>] BR            >>:[{self.regions['br']}]{space * (18 - len(str(self.regions['br'])))}┃ ┃ [>] 35-40           >>:[{self.skinsam['35-40']}]{space * (29 - len(str(self.skinsam['35-40'])))}┃
 ┃ [>] Errors         >>:[{self.err}]{space * (12 - len(str(self.err)))}┃ ┃ [>] KR            >>:[{self.regions['kr']}]{space * (18 - len(str(self.regions['kr'])))}┃ ┃ [>] 40-70           >>:[{self.skinsam['40-70']}]{space * (29 - len(str(self.skinsam['40-70'])))}┃
 ┃ [>] Retries        >>:[{self.retries}]{space * (12 - len(str(self.retries)))}┃ ┃ [>] LATAM         >>:[{self.regions['latam']}]{space * (18 - len(str(self.regions['latam'])))}┃ ┃ [>] 70+             >>:[{self.skinsam['70+']}]{space * (29 - len(str(self.skinsam['70+'])))}┃
 ┃                                     ┃ ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛ ┃{space * (56 - len(str(self.skinsam['1-10'])))}┃
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛ ┏━━ Ranks ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓ ┃{space * (56 - len(str(self.skinsam['1-10'])))}┃
 ┏━ Not main ━━━━━━━━━━━━━━━━━━━━━━━━━━┓ ┃ [>] Unranked      >>:[{self.ranks['unranked']}]{space * (18 - len(str(self.ranks['unranked'])))}┃ ┃{space * (56 - len(str(self.skinsam['1-10'])))}┃
 ┃ [>] With Skins       >>:[{self.skins}]{space * (10 - len(str(self.skins)))}┃ ┃ [>] Iron          >>:[{self.ranks['iron']}]{space * (18 - len(str(self.ranks['iron'])))}┃ ┃                                                       ┃
 ┃ [>] Unverified Mail  >>:[{self.unverifiedmail}]{space * (10 - len(str(self.unverifiedmail)))}┃ ┃ [>] Bronze        >>:[{self.ranks['bronze']}]{space * (18 - len(str(self.ranks['bronze'])))}┃ ┃                                                       ┃
 ┃                                     ┃ ┃ [>] Silver        >>:[{self.ranks['silver']}]{space * (18 - len(str(self.ranks['silver'])))}┃ ┃                                                       ┃
 ┃                                     ┃ ┃ [>] Gold          >>:[{self.ranks['gold']}]{space * (18 - len(str(self.ranks['gold'])))}┃ ┃                                                       ┃
 ┃                                     ┃ ┃ [>] Platinum      >>:[{self.ranks['platinum']}]{space * (18 - len(str(self.ranks['platinum'])))}┃ ┃                                                       ┃
 ┃                                     ┃ ┃ [>] Diamond       >>:[{self.ranks['diamond']}]{space * (18 - len(str(self.ranks['diamond'])))}┃ ┃                                                       ┃
 ┃                                     ┃ ┃ [>] Ascendant     >>:[{self.ranks['ascendant']}]{space * (18 - len(str(self.ranks['ascendant'])))}┃ ┃                                                       ┃
 ┃                                     ┃ ┃ [>] Immortal      >>:[{self.ranks['immortal']}]{space * (18 - len(str(self.ranks['immortal'])))}┃ ┃                                                       ┃
 ┃                                     ┃ ┃ [>] Radiant       >>:[{self.ranks['radiant']}]{space * (18 - len(str(self.ranks['radiant'])))}┃ ┃                                                       ┃
 ┃                                     ┃ ┃ [>] Locked        >>:[{self.locked}]{space * (18 - len(str(self.locked)))}┃ ┃                                                       ┃
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛ ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛ ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
  Estimated remaining time: 99 years
   ''')